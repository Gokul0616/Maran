...
def main():
    ...
    model = GPTModel(vocab_size=vocab_size, d_model=256, nhead=8, num_layers=4)
    ...
    res, r = engine.improve("Refactor tree of thought planner")
    logger.info(f"Improvement result: {res}, reward: {r}")
    while True:
        try:
